...
<div class="row">
	<div class="col-md-12">
		...
		<form action="<?php echo userpanel\url('cronjob/tasks/delete/'.$this->task->id); ?>" method="POST">
			<div class="alert alert-block alert-warning fade in">
				...
				<p>
					...
					<button type="submit" class="btn btn-yellow"><i class="fa fa-trash-o tip"></i> <?php echo translator::trans("monitoring.delete") ?></button>
				</p>
			</div>
		</form>
